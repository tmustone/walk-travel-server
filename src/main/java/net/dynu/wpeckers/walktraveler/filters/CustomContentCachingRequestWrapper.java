...
public class CustomContentCachingRequestWrapper extends HttpServletRequestWrapper {
    ...
    private boolean isFormPost() {
        ...
        // Fixed this point to allow GET, PUT and other HttpMethods than just POST to print request data
    ...
    private class ContentCachingInputStream extends ServletInputStream {
        ...
        public int read() throws IOException {
            ...
            if (ch != -1 && !this.overflow) {
                if (CustomContentCachingRequestWrapper.this.contentCacheLimit != null && CustomContentCachingRequestWrapper.this.cachedContent.size() == CustomContentCachingRequestWrapper.this.contentCacheLimit) {
                    this.overflow = true;
                    CustomContentCachingRequestWrapper.this.handleContentOverflow(CustomContentCachingRequestWrapper.this.contentCacheLimit);
                } else {
                    CustomContentCachingRequestWrapper.this.cachedContent.write(ch);
                }
            }
        ...
        private void writeToCache(byte[] b, int off, int count) {
            if (!this.overflow && count > 0) {
                if (CustomContentCachingRequestWrapper.this.contentCacheLimit != null && count + CustomContentCachingRequestWrapper.this.cachedContent.size() > CustomContentCachingRequestWrapper.this.contentCacheLimit) {
                    this.overflow = true;
                    CustomContentCachingRequestWrapper.this.cachedContent.write(b, off, CustomContentCachingRequestWrapper.this.contentCacheLimit - CustomContentCachingRequestWrapper.this.cachedContent.size());
                    CustomContentCachingRequestWrapper.this.handleContentOverflow(CustomContentCachingRequestWrapper.this.contentCacheLimit);
                    return;
                }

                CustomContentCachingRequestWrapper.this.cachedContent.write(b, off, count);
            }
